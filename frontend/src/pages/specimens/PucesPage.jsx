...
export default function PucesPage() {
  ...
  const rows = useMemo(() => sortRows(data?.puces ?? [], sort, t('common.locale')), [data, sort, t]);
      ...
      {loading && !data ? (
        ...
        <Card padding="none" className="overflow-hidden">
          ...
          <DataTable
            ...
            onRowClick={(r) => navigate(`/specimens/puces/${r.id}`)}
            minWidth="820px"
            empty={
