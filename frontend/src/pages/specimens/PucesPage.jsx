...
export default function PucesPage() {
  ...
  return (
    <div className="space-y-5">
      <PageHeader
        icon={() => <SpecimenIcon type="puce" size={18} />} iconTone="specimen-puce"
        title="Puces" subtitle={`${total} spécimen(s) au total`}
        actions={
          <>
                ...
                {loading ? (
                  ...
                  <tr key={p.id} className="hover:bg-specimen-puce/5 transition-colors cursor-pointer"
                    ...
                    <td className="px-4 py-3">
                      {p.idTerrain ? <Badge tone="primary" size="sm" className="font-mono font-bold">{p.idTerrain}</Badge>
